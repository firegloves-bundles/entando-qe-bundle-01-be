...
describe('ConferenceTable', () => {
  it('shows conferences', () => {
    ...
    expect(getByText(conferenceMocks[0].room.toString())).toBeInTheDocument();
    expect(getByText(conferenceMocks[1].room.toString())).toBeInTheDocument();
  ...
  it('shows no conferences message', () => {
    ...
    expect(queryByText(conferenceMocks[0].room.toString())).not.toBeInTheDocument();
    expect(queryByText(conferenceMocks[1].room.toString())).not.toBeInTheDocument();
