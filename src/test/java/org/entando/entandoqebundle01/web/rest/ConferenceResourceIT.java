package org.entando.entandoqebundle01.web.rest;
...
import org.entando.entandoqebundle01.IntegrationTest;
import org.entando.entandoqebundle01.domain.Conference;
import org.entando.entandoqebundle01.repository.ConferenceRepository;
...
class ConferenceResourceIT {
    ...
    public static Conference createEntity(EntityManager em) {
        Conference conference = new Conference().room(DEFAULT_ROOM).name(DEFAULT_NAME);
        return conference;
    }
    ...
    public static Conference createUpdatedEntity(EntityManager em) {
        Conference conference = new Conference().room(UPDATED_ROOM).name(UPDATED_NAME);
        return conference;
    }
    ...
    void createConference() throws Exception {
        ...
        assertThat(testConference.getRoom()).isEqualTo(DEFAULT_ROOM);
    ...
    void putNewConference() throws Exception {
        ...
        updatedConference.room(UPDATED_ROOM).name(UPDATED_NAME);
        ...
        Conference testConference = conferenceList.get(conferenceList.size() - 1);
        assertThat(testConference.getRoom()).isEqualTo(UPDATED_ROOM);
    ...
    void fullUpdateConferenceWithPatch() throws Exception {
        ...
        partialUpdatedConference.room(UPDATED_ROOM).name(UPDATED_NAME);
